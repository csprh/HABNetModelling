...
class ResearchModels():
    ...
    def lstm3(self):
        ...
        # Model.
        model = Sequential()
        #model.add(TimeDistributed(Conv1D(filters=1, kernel_size=3,  activation='relu'), input_shape=(self.input_shape[0], self.input_shape[1],1)))
        model.add(TimeDistributed(MaxPooling1D(pool_size=2),input_shape=(self.input_shape[0], self.input_shape[1],1)))
